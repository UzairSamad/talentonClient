...
export const ValidationSchema = {
  logInEmail: yup.object().shape({
    email: Validation.email('Email'),
  }),
  logInCode: yup.object().shape({
    code: Validation.requiredWithoutTrim('Code'),
  }),
  signup: yup.object().shape({
    name: Validation.requiredWithoutTrim('Name'),
    email: Validation.requiredWithoutTrim('Email'),
    phone: Validation.requiredWithoutTrim('Phone'),
    compnany: Validation.requiredWithoutTrim('Company Name'),
    designation: Validation.requiredWithoutTrim('Designation'),
  }),
  ...
  basicInfoPhase1: yup.object().shape({
    city: Validation.requiredWithoutTrim('City'),
  }),
  basicInfoPhase2: yup.object().shape({
    hour: Validation.requiredWithoutTrim('Hour'),
    optional: Validation.requiredWithoutTrim('Optional'),
    hours: Validation.requiredWithoutTrim('Hours'),
    visaType: Validation.requiredWithoutTrim('Visa Type'),
    vaccinations: Validation.requiredWithoutTrim('Vaccinations'),
  }),
  projectName: yup.object().shape({
    projectName: Validation.requiredWithoutTrim('Project Name'),
  }),
  filter: yup.object().shape({
    country: Validation.requiredWithoutTrim('State/Country'),
    minimum: Validation.requiredWithoutTrim('Minimum'),
    maximum: Validation.requiredWithoutTrim('Maximum'),
  }),
  role: yup.object().shape({
    role: Validation.requiredWithoutTrim('Role'),
  }),
  industry: yup.object().shape({
    industry: Validation.requiredWithoutTrim('Industry'),
  }),
};
